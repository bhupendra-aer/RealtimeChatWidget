...
/**
 * calculate the time spent between two dates
...
export function setHeaderDate(timestamp): string {
    ...
    // if the dates are different or the reference date is not set
    // returns the calculated date
    // otherwise come back null
    return labelDays;
}
...
/**
 * returned index item in the array with uid == key
 * @param items
 * @param key
 */
...
/**
 * transforms url contents into the text passed in tags <a>
 */
